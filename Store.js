...
module.exports = {
    ...
    async loadData () {
        ...
        let startPixels = await axios.get("https://pixel-dev.w84.vkforms.ru/api/data", {
            headers: {
                ...
                'Referer': `https://prod-app7148888-0980885d2a54.pages.vk-apps.com/index.html`,
    ...
    async loadImg () {
        ...
        let img = await loadImage("https://pixelbot.s3.eu-north-1.amazonaws.com/pixelart.png?" + parseInt(new Date().getTime() / 1000));
